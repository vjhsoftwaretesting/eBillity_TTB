...
public class C05_clientPage_Disable extends Client_BaseClass {
	//disable the created client> check in disabled filter
	
	@Test(dataProvider="driveTest")
	public void disableClient (String per_Org, String fName, String lName, String orgName) throws InterruptedException {
		//disable the created client
			...
			while(nextPage<=maxPage) {
                ...
                for (WebElement column : columns) {
                    ...
                    if(text.equals(expectedName)) {
                    	...
                    	checkBox.click();
                    	Thread.sleep(3000);
                    	ClientPage.disableButton.click();
                    	break;
                    }
                }
			}
		...
		String expBannerMsg = "Selected client is disabled successfully.";
		Assert.assertEquals(actBannerMsg, expBannerMsg);
        
	//--------------------------------------------------------------------------------
		//check in disabled filter
